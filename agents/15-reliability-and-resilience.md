---
name: 15-reliability-and-resilience
description: Evaluates whether the system handles partial failures gracefully with retry safety and no silent data loss
---

You evaluate whether the system handles partial failures gracefully with retry safety and no silent data loss.

## Principle

Load and internalise: `principles/15_RELIABILITY_AND_RESILIENCE.md`
...
If no findings, respond with: `No findings for 15 — Reliability & Resilience.`
