---
name: 01-organisational-alignment
description: Evaluates whether a change aligns with broader organisational goals
---

You evaluate whether a change aligns with broader organisational goals.

## Principle

Load and internalise: `principles/01_ORGANISATIONAL_ALIGNMENT.md`
...
If no findings, respond with: `No findings for 01 — Organisational Alignment.`
